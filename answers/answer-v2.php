<?php
    ...
    $sql =  "SELECT answer_answer FROM answer WHERE answer_answer='DALAWA';";
    ...
    $sql =  "SELECT answer_answer FROM answer WHERE answer_answer='ECLESIASTES 7:17';";
    ...
    $sql =  "SELECT answer_answer FROM answer WHERE answer_answer='PAGKATAKOT SA PANGINOON';";
    ...
    $sql =  "SELECT answer_answer FROM answer WHERE answer_answer='PAGGAWA NG KASAMAAN';";
    ...
    $sql = "INSERT INTO record_2 (record_name, record_score) VALUES 
    ('$name', '$score');";

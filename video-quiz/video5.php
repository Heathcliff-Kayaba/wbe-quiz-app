...
<body>
    ...
    <main>
        <div class="embed-responsive embed-responsive-16by9">
            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/N6YGHvkv4_o"></iframe>
        </div>  
    </main> 
    <footer>
        <div class="card text-center">
            ...
            <div class="card-body">
                ...
                <a class="btn btn-primary" data-toggle="collapse" data-target="#quiz-five">Quiz 5</a>
                <div class="collapse" id="quiz-five">
                    <h5>Answer should be in capital letters. You can use special characters such as -_/*!@#$%^&*.</h5>
                    <form action="../answers/answer-v5.php" method="POST">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">1</th>
                                    <td>Nagaganap ba agad ang kahilinginan ng tao sa Dios?</td>
                                    <td></td>
                                    <td><input type="text" name="answer-one" placeholder="Enter your Answer"></td>
                                </tr>
                                <tr>
                                    <th scope="row">2</th>
                                    <td>Ano ang dahilan kung bakit hindi pa naibibigay ang kahilinginan?</td>
                                    <td></td>
                                    <td><input type="text" name="answer-two" placeholder="Enter your Answer"></td>
                                </tr>
                                <tr>
                                    <th scope="row">3</th>
                                    <td>Sa anong verse mababasa ang katunayang ang “Sa Panahong Ukol kitay pinakinggan?</td>
                                    <td></td>
                                    <td><input type="text" name="answer-three" placeholder="Enter your Answer"></td>
                                </tr>
                                <tr>
                                    <th scope="row">4</th>
                                    <td>Sa anong verse mababasa na ang Dios ay hindi nagbibigay sa nagsisihingi na hindi nagsisisitanggap, sapagkat nagsisishingi sa masama upang gugulin sa Kalayawan?</td>
                                    <td></td>
                                    <td><input type="text" name="answer-four" placeholder="Enter your Answer"></td>
                                </tr>
                                <tr>
                                    <th scope="row">5</th>
                                    <td>Ano ang katunayan na ang bawat bagay ay may kapanahunan ayon sa Bibliya?</td>
                                    <td></td>

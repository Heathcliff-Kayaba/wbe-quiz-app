...
<body>
    ...
    <main>
        <div class="embed-responsive embed-responsive-16by9">
            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/MtXe47gO46U"></iframe>
        </div>  
    </main> 
    <footer>
        <div class="card text-center">
            ...
            <div class="card-body">
                ...
                <a class="btn btn-primary" data-toggle="collapse" data-target="#quiz-three">Quiz 3</a>
                <div class="collapse" id="quiz-three">
                    <h5>Answer should be in capital letters. You can use special characters such as -_/*!@#$%^&*.</h5>
                    <form action="../answers/answer-v3.php" method="POST">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">1</th>
                                    <td>Ayon sa Biblia ang bawa’t nagmamataas ay __________; at ang nagpapakababa ay ______________.</td>
                                    <td></td>
                                    <td><input type="text" name="answer-one" placeholder="Enter your Answer"></td>
                                </tr>
                                <tr>
                                    <th scope="row">2</th>
                                    <td>May Kristiano bang suplado ayon sa Biblia?</td>
                                    <td></td>
                                    <td><input type="text" name="answer-two" placeholder="Enter your Answer"></td>
                                </tr>
                                <tr>
                                    <th scope="row">3</th>
                                    <td>Ano ang dapat maging ugali ng isang Kristiano?</td>
                                    <td></td>
                                    <td><input type="text" name="answer-three" placeholder="Enter your Answer"></td>
                                </tr>
                                <tr>
                                    <th scope="row">4</th>
                                    <td>Saang talata ng Biblia mababasa ang dapat magaging ugali ng Kristiano?</td>
                                    <td></td>
                                    <td><input type="text" name="answer-four" placeholder="Enter your Answer"></td>
                                </tr>
                                <tr>
                                    <th scope="row">5</th>
                                    <td>Saang talata sa Biblia mababasa na masama ang pagiging suplado?</td>
                                    <td></td>

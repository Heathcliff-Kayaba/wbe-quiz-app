...
<body>
    ...
    <main>
        <div class="embed-responsive embed-responsive-16by9">
            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/XmeLammR0tI"></iframe>
        </div>  
    </main> 
    <footer>
        <div class="card text-center">
            ...
            <div class="card-body">
                ...
                <a class="btn btn-primary" data-toggle="collapse" data-target="#quiz-four">Quiz 4</a>
                <div class="collapse" id="quiz-four">
                    <h5>Answer should be in capital letters. You can use special characters such as -_/*!@#$%^&*.</h5>
                    <form action="../answers/answer-v4.php" method="POST">

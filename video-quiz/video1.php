...
<body>
    ...
    <main>
        <div class="embed-responsive embed-responsive-16by9">
            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/qc7NaeMdz1E"></iframe>
        </div>  
    </main> 
    <footer>
        <div class="card text-center">
            ...
            <div class="card-body">
                ...
                <a class="btn btn-primary" data-toggle="collapse" data-target="#quiz-one">Quiz 1</a>
                <div class="collapse" id="quiz-one">
                    <h5>Answer should be in capital letters. You can use special characters such as -_/*!@#$%^&*.</h5>
                    <form action="../answers/answer-v1.php" method="POST">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">1</th>
                                    <td>Gaano ba kahaba o kaiksi ang pagkakataong maaaring ibigay sa kanya?</td>
                                    <td></td>
                                    <td><input type="text" name="answer-one" placeholder="Enter your Answer"></td>
                                </tr>
                                <tr>
                                    <th scope="row">2</th>
                                    <td>Ayon sa tanong kung gaano ba kahaba o kaiksi ang pagkakataong maaaring ibigay sa kanya, saang tatala mababasa ang sagot?</td>
                                    <td></td>
                                    <td><input type="text" name="answer-two" placeholder="Enter your Answer"></td>
                                </tr>
                                <tr>
                                    <th scope="row">3</th>
                                    <td>Based on the video, what is our nearest future?</td>
                                    <td></td>
                                    <td><input type="text" name="answer-three" placeholder="Enter your Answer"></td>
                                </tr>
                                <tr>
                                    <th scope="row">4</th>
                                    <td>Ano ang dapat di ipaghambog?</td>
                                    <td></td>
                                    <td><input type="text" name="answer-four" placeholder="Enter your Answer"></td>
                                </tr>
                                <tr>
                                    <th scope="row">5</th>
                                    <td>Ang bawat araw ay ______________ kaya dapat nating samatalahin ang pagkakataon.</td>
                                    <td></td>
